...
<body>
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control search"
                                            name="search_input" id="search_input" placeholder="Search Territories">
                                        <select name="search_territories" id="search_territories">
                                            <option value="#">
                                                -- Choose category --
                                            </option>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title m-0" id="myLargeModalLabel">Create Territories</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <!--end modal-header-->
                <div class="modal-body">

                    <form id="add_territories_form" method="POST">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>Territories Code</label>
                                    <input type="text" class="form-control" id="add_code" name="add_code"
                                        placeholder="territories Code" maxlength="10">
                                </div>
                                <div class="col-md-6">
                                    <label>Territories Name</label>
                                    <input type="text" class="form-control" id="add_name" name="add_name"
                                        placeholder="territories Name" maxlength="100" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12  mt-3">
                                    ...
                                    <textarea type="text" class="form-control" id="add_defination" name="add_defination"
                                        placeholder="territories Definition" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12  mt-3">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-square btn-outline-dashed"
                                        id="add_territories">Save</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div class="modal fade bd-example-modal-lg" id="modal_edit" aria-labelledby="myLargeModalLabel3" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title m-0" id="myLargeModalLabel3">Edit Territories</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <!--end modal-header-->
                <div class="modal-body">

                    <form id="edit_territories_form" method="POST">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>Territories Code</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="edit_name" name="edit_name"
                                        placeholder="territories Name" maxlength="100">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12  mt-3">
                                    <label>Territories Definition</label>
                                    <textarea type="text" class="form-control" id="edit_defination"
                                        name="edit_defination" placeholder="territories Definition"></textarea>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12  mt-3">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-square btn-outline-dashed"
                                        id="edit_territories">Save</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script src="../../assets/js/pagejs/territories.js"></script>
