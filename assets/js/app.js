...
$( ".printButton" ).click(function() {
  $('.printArea').printThis({
        // pageTitle: "<?php echo $get_title ?>",
        header: "<h4 style='text-align: center;'>Savoy Ice Cream Factory Limited</h4>"
    });
});
...
(function($) {
    ...
    $("#search_input").on("keyup", function() {
        ...
        var search_value = $('#search_select').val();
        ...
        if(search_value == ''){
           ...
           $('tbody tr').each(function(){
            ...
            var search_select = parseInt(search_value) + 1;

            $("table tr td:nth-child(" + search_select + ")").each(function() {
